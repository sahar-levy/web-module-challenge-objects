...
console.log('task 1b:', createMenuItem('grilled salmon', 32.75, 'Dinner'));
console.log('task 1b:', createMenuItem('vegan curry', 20, 'Lunch'));
console.log('task 1b:', createMenuItem('paella', 10, 'Lunch'));
...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
Write a function that creates an object with name, rating, feedback, adds the new review to the end of an array and returns the resulting array. 
...
*/
 ...
 function getReviewByRating(array, rating) {
    let reviewsInRange = reviews.filter(review => review.rating >= rating && review.rating < rating + 1);
...
function getLongReviews(array) {
    let longReviewsArray = reviews.filter(review => review.length > 15);
